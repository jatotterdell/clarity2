...
kable(stage2dec_tab,
  format = "latex",
  col.names = c(
    "OR (control 1, inv. arm)",
    "Investigational\nvs control 1", "Investigational\nvs control 2", "Investigational\nvs both"
  ),
...
ggplot(
  stop_res_ppos[eff_eps == 0.95 & analysis <= K & !grepl("0.91", OR)],
  aes(analysis, P)
) +
